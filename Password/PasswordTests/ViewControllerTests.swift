...
final class ViewControllerTests_NewPassword_Validation: XCTestCase {
    ...
    func testInvalidPassword() throws {
        ...
        XCTAssertEqual(vc.newPasswordTextField.errorLabel.text!, "Enter valid special characters (.,@:?!()$\\/#) with no spaces")
    }
...
final class ViewControllerTests_Confirm_Password_Validation: XCTestCase {
    var vc: ViewController!
    let validPassword = "12345678Aa!"
    let tooShort = "1234Aa!"
